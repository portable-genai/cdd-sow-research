...
export const metadata: Metadata = {
  title: "CDD + Source-of-Wealth Agent",
  description:
    "Demo console for the CDD + Source-of-Wealth Agent: cited CDD dossiers from a KYC pack, corporate registries and adverse media.",
};
